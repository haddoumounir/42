...
/*   Updated: 2025/03/25 01:08:56 by mhaddou          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
if	((!is_scd(str[data.pos])
			&& !ft_isdigit(str[data.pos])&& !is_white_space(str[data.pos])))
*/
int	scdw(int c)
{
	if (!is_scd(c) && !ft_isdigit(c) && !is_white_space(c))
		return (0);
	else
		return (1);
}
